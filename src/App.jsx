...
      // This endpoint already correctly uses /api/teams/
...
      }
      // If response is not ok (e.g., 404), it means no team found, which is expected.
      return null;
    } catch (error) {
...
        console.warn(`You already selected ${previouslySelected.name}. Please re-select that to continue.`);
        // For now, we'll just return, but ideally, show a UI message
        return;
      }
    }
